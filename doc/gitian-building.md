...
*Setup instructions for a gitian build of Megacoin using a Debian VM or physical system.*
...
- [Building Megacoin](#building-megacoin)
...
Clone the git repositories for megacoin and gitian and then checkout the megacoin version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/megacoin-project/megacoin.git
cd megacoin
...
Follow the instructions in [doc/release-process.md](release-process.md) in the megacoin repository
...
To build Megacoin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the megacoin repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/megacoin-project/megacoin
...
For example:
```bash
URL=https://github.com/user/megacoin.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/megacoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/megacoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/megacoin-build.assert
```
...
[megacoin/gitian.sigs](https://github.com/megacoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
request. 
