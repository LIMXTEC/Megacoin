Bitcoin Core version 0.13.0 is now available from:
  ...
  <https://megacoin.cc/bin/megacoin-core-0.13.0/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://megacoincore.org/en/list/announcements/join/>
...
141](https://github.com/megacoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/megacoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/megacoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/megacoin/bips/blob/master/bip-0145.mediawiki) are
...
- #7550 `8b958ab` Input-from-stdin mode for megacoin-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to megacoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add megacoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: megacoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from megacoind (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for megacoind procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of megacoind startup (laanwj)
...
- #7975 `fc23fee` Update megacoin-core GitHub links (MarcoFalke)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/megacoin/).
