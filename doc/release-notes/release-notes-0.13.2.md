Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://megacoin.cc/bin/megacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update megacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow megacoin-tx to create v2 transactions (btcdrak)
