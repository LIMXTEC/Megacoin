Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/megacoin/files/Bitcoin/megacoin-0.7.0/

We recommend that everybody running prior versions of megacoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/megacoin/megacoin/tarball/v0.7.0  # .tar.gz
  https://github.com/megacoin/megacoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the megacoin-qt package:
  sudo apt-get install megacoin-qt
...
Core megacoin handling and blockchain database
...
* Ensure a changed megacoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for megacoin-qt.exe
* (Windows only): add meta-data to megacoin-qt.exe (e.g. description)
...
* Bash programmable completion for megacoind(1)
