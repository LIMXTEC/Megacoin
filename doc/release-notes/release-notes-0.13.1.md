Bitcoin Core version 0.13.1 is now available from:
  ...
  <https://megacoin.cc/bin/megacoin-core-0.13.1/>
...
[versionbits FAQ]: https://megacoincore.org/en/2016/06/08/version-bits-miners-faq/
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in megacoinconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.megacoinstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libmegacoinconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_megacoin by itself (luke-jr)
...
- #8829 `2a8bca4` Add megacoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` megacoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_megacoinds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name megacoin.qrc  (megacoinsSG)
...
- #8817 `bcf3806` update megacoin-tx to output witness data (jnewbery)
