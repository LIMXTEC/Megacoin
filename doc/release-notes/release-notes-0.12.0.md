Bitcoin Core version 0.12.0 is now available from:
  ...
  <https://megacoin.cc/bin/megacoin-core-0.12.0/>
...
(https://github.com/megacoin/bips/blob/master/bip-0125.mediawiki).
...
notes of v0.11.0](https://github.com/megacoin/megacoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
...
- #6269 `d4565b6` gitian: Use the new megacoin-detached-sigs git repo for OSX signatures (Cory Fields)
...
- #6600 `ef4945f` Include megacoin-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix megacoin-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of megacoin-cli on secp256k1 (Wladimir J. van der Laan)
...
- #7209 `f3ad812` test: don't override MEGACOIND and MEGACOINCLI if they're set (Wladimir J. van der Laan)
...
- #6387 `11576a5` [megacoin-cli] improve error output (Jonas Schnelli)
- #6401 `6db53b4` Add MEGACOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
- #6430 `b01981e` doc: add documentation for shared library libmegacoinconsensus (Braydon Fuller)
