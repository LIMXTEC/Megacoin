Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://megacoin.cc/bin/megacoin-core-0.11.0/>
...
For example, add the following to `megacoin.conf`:
...
related to the blockchain in the megacoin system: the raw blocks as received over 
...
For an example script see [megacoin-submittx](https://github.com/laanwj/megacoin-submittx).
...
- #5334 `cf87536` libmegacoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new megacoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add megacoin logo to about screen
...
- #5809 `46bfbe7` Add megacoin-cli man page
...
- #5849 `41259ca` contrib/init/megacoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for megacoin-tx)
