...
Also test that nodes that send unsupported service bits to megacoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if megacoind ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
