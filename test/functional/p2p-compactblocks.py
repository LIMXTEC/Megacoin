...
# TestNode: A peer we use to send messages to megacoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes megacoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that megacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for megacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # megacoind will not send blocktxn responses for blocks whose height is
