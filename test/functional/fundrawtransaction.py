...
from test_framework.test_framework import BitcoinTestFramework, MEGACOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid megacoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.megacoind_processes[1].wait(timeout=MEGACOIND_PROC_WAIT_TIMEOUT)
