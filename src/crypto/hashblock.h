...
#define HASH_FUNC_BASE_TIMESTAMP 1492973331 // MegaCoin: Genesis Timestamp
#define HASH_FUNC_COUNT 10                   // MegaCoin: HASH_FUNC_COUNT of 11
#define HASH_FUNC_COUNT_PERMUTATIONS 40320  // MegaCoin: HASH_FUNC_COUNT!
