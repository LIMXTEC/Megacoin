...
const char * const MEGACOIN_CONF_FILENAME = "megacoin.conf";
const char * const MEGACOIN_PID_FILENAME = "megacoin.pid";
...
fs::path GetPidFile()
{
    fs::path pathPidFile(gArgs.GetArg("-pid", MEGACOIN_PID_FILENAME));
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    */
    ...
    strCopyrightHolders += "\n" + strYear + "The Megacoin Core developers";
