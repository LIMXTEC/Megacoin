...
void CSporkManager::LoadSporksFromDB()
{
    ...
    for (int i = SPORK_START; i <= SPORK_MEGACOIN_END; ++i) {
        if (i > SPORK_END && i < SPORK_MEGACOIN_START) i = SPORK_MEGACOIN_START;
    // FXTC END
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_SCRYPT:      r = SPORK_MEGACOIN_01_HANDBRAKE_FORCE_SCRYPT_DEFAULT; break;
            case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5:       r = SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5_DEFAULT; break;
            case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z:      r = SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z_DEFAULT; break;
            case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11:         r = SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11_DEFAULT; break;
            case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R:        r = SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R_DEFAULT; break;

            case SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     r = SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE_DEFAULT; break;
            case SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK:         r = SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK_DEFAULT; break;
            case SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE:         r = SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE_DEFAULT; break;
            case SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE:      r = SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE_DEFAULT; break;
            case SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE:      r = SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5:       return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5_DEFAULT;
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z:      return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z_DEFAULT;
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11:         return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11_DEFAULT;
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R:        return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R_DEFAULT;

        case SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     return SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE_DEFAULT;
        case SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK:         return SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK_DEFAULT;
        case SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE:         return SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE_DEFAULT;
        case SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE:      return SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE_DEFAULT;
        case SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE:      return SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_SCRYPT")      return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_SCRYPT;
    if (strName == "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5")       return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5;
    if (strName == "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z")      return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z;
    if (strName == "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11")         return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11;
    if (strName == "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R")        return SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R;

    if (strName == "SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE")     return SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE;
    if (strName == "SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK")         return SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK;
    if (strName == "SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE")         return SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE;
    if (strName == "SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE")      return SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE;
    if (strName == "SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE")      return SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_SCRYPT:      return "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_SCRYPT";
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5:       return "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_NIST5";
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z:      return "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_LYRA2Z";
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11:         return "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X11";
        case SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R:         return "SPORK_MEGACOIN_01_HANDBRAKE_FORCE_X16R";

        case SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     return "SPORK_MEGACOIN_02_IGNORE_SLIGHTLY_HIGHER_COINBASE";
        case SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK:         return "SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_CHECK";
        case SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE:         return "SPORK_MEGACOIN_02_IGNORE_FOUNDER_REWARD_VALUE";
        case SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE:      return "SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_VALUE";
        case SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE:      return "SPORK_MEGACOIN_02_IGNORE_MASTERNODE_REWARD_PAYEE";
