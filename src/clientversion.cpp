 ...
 */
const std::string CLIENT_NAME("MegaCoin");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/megacoin/bips/blob/master/bip-0014.mediawiki) 
 */
