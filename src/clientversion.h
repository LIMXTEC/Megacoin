...
#error Client version information missing: version is not defined by megacoin-config.h or in any other way
#endif
...
/**
 * megacoind-res.rc includes this file, but it cannot cope with real c++ code.
