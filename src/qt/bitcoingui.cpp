    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Megacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Megacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Megacoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Megacoin Core help message to get a list with possible Megacoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Megacoin Core client") + " " + networkStyle->getTitleAddText();
