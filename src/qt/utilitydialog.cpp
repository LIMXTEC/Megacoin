...
/** "PaperWallet" dialog box - Limx dev 2015 Paper wallet art provided by Anacoluthia.*/
...
void PaperWalletDialog::on_printButton_clicked()
{
    ...
    while( true ) {
        ...
        double amountInput = QInputDialog::getDouble(this, tr("Load Paper Wallets"), tr("Please wait for wallets to print and verify readability.<br/>Enter the number of MEC you wish to send to each wallet:"), 0, 0, 2147483647, 8, &ok);
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Megacoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Megacoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Megacoin Core is shutting down...") + "<br /><br />" +
