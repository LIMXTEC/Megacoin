...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // megacoin: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. MegaCoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(megacoin_locale);
    ...
    /// 6. Determine availability of data directory and parse megacoin.conf
    ...
    // megacoin: links repeatedly have their payment requests routed to this process:
