...
#ifndef H_MEGACOIN_SCRIPT
#define H_MEGACOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMegacoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Megacoin always counted CHECKMULTISIGs
