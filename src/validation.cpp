...
public:
    ...
    int64_t Height(const Consensus::Params& params) const override { return 1280000; }
    ...
    bool Condition(const CBlockIndex* pindex, const Consensus::Params& params) const override
    {
		...
		return pindex->nHeight >= 1280000;//current height
    }
};
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    if (block.vtx[0]->GetValueOut() > blockReward)
        ...
        if (!sporkManager.IsSporkActive(SPORK_MEGACOIN_02_IGNORE_EXTRA_REWARD_CHECK) && founderReward > 0) {
            ...
            if (IsValidDestination(destination)) {
                ...
                for (const auto& output : block.vtx[0]->vout) {
                    if (output.scriptPubKey == FOUNDER_SCRIPT && ((output.nValue == founderReward) || sporkManager.IsSporkActive(SPORK_MEGACOIN_02_IGNORE_EXTRA_REWARD_VALUE))) {
                        FounderPaid = true;
                        break;
                    }
                }
