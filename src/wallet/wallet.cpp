...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/megacoin/megacoin/pull/10340, but that change has been
    // postponed until after https://github.com/megacoin/megacoin/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-megacoin-address
 ...
 * https://megacointalk.org/?topic=54527, or
 * https://github.com/megacoin/megacoin/pull/1393.
 */
