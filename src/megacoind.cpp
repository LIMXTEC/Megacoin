 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Bitcoin (https://www.megacoin.cc/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||  gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  megacoind [options]                     " + strprintf(_("Start %s Daemon"), _(PACKAGE_NAME)) + "\n";

            strUsage += "\n" + HelpMessage(HMM_MEGACOIND);
        }
    ...
    try
    {
        ...
        // -server defaults to true for megacoind but not for the GUI so do this here
