...
WORKINGDIR="/tmp/megacoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/megacoin/Megacoin/megacoin-0.8.99/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/megacoin/Megacoin/"
VERSIONPREFIX="megacoin-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[megacoin-]<version>-[rc[0-9]] (example: megacoin-0.7.1-rc1)"
   echo "wget output:"
